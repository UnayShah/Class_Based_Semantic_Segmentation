...
class TransformerNet(Module):
    def __init__(self) -> None:
        ...
        self.conv_4 = ConvLayer(128, 256, 3, 2)
        self.instance_norm_4 = InstanceNorm2d(256, affine=True)

        # Residual layers
        self.res_1 = ResidualBlock(256, 256)
        self.res_2 = ResidualBlock(256, 256)
        self.res_3 = ResidualBlock(256, 256)
        self.res_4 = ResidualBlock(256, 256)
        ...
        self.upsample_3 = UpsampleConv(64, 32, 3, 1, 2)
        self.instance_norm_7 = InstanceNorm2d(32, affine=True)
        self.upsample_4 = UpsampleConv(32, 3, 9, 1)
    ...
    def forward(self, x):
        ...
        out = self.relu(self.instance_norm_4(self.conv_4(out)))
        ...
        out = self.relu(self.instance_norm_7(self.upsample_3(out)))
